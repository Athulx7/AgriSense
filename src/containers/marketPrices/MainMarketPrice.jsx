...
function MainMarketPrice() {
    
    const tabs = [
        { name: "Price Overview", path: "priceOverview" },
        { name: "Market Trends", path: "marketTrends" },
        { name: "Trending Alerts", path: "expReport" },]
    return (
       <div className='bg-primary dark:bg-gray-800 dark:text-white pb-2'>
            <div className='pt-10 px-8'>
                ...
                <div className='py-3 text-gray-700 dark:text-gray-300'>Monitor commodity prices and market trends to optimize your selling strategy</div>
            </div>
...
export default MainMarketPrice
