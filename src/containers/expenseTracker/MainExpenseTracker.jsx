...
function MainExpenseTracker() {
    ...
    const tabs = [
        { name: "Overview", path: "expOverview" },
        { name: "Categories", path: "expCategory" },
        { name: "Reports", path: "expReport" },]
    return (
        <div className='bg-primary dark:bg-gray-800 dark:text-white pb-2'>
            <div className='pt-10 px-8'>
                ...
                <div className='py-3 text-gray-700 dark:text-gray-300'>Monitor and analyze your farm expenses for better financial management</div>
            </div>
