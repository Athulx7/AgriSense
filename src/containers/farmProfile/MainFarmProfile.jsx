...
function MainFarmProfile() {
    const tabs = [
        { name: "Farm Overview", path: "overview" },
        { name: "Crop Management", path: "crops" },
        { name: "Field Map", path: "map" },
    ...
    return (
        <div className='bg-primary dark:bg-gray-800 dark:text-white pb-2'>
            <div className='pt-10 px-8'>
                ...
                <div className='py-3 text-gray-700 dark:text-gray-300'>Manage your farm information, crops, and field configurations</div>
            </div>
...
export default MainFarmProfile
